...
public class CityDataStore
{
    ...
    public CityDataStore()
    {
        Cities = new List<CityDto>()
        {
            ...
            new CityDto(){Id=2,Name="Shiraz",Description="This Is My City",PointsOfInterest=new List<PointOfInterestDto>()
                {
            ...
            new CityDto(){Id=3,Name="Ahvaz",Description="This Is My City",PointsOfInterest=new List<PointOfInterestDto>()
                {
